...
client=Client("QoukvJkask8R91Ql1A122wtuW1IykLIDcmBYFdav1ftrqEyPY5XkrtAOTqkZDP3l","EC1kzfy9K8R5hqyJHYEEPdfvrRNHLYa1oqDhi17svEXutjWy4HCYRVQndHlVWYfr")
...
#     print("here")
    for a in soup.findAll('tr', attrs={'class':'coin'}):
        ...
        if (recent_vol_percentage>0.7 and pings>3 and pings<10 and net_vol_percentage > 0.8) :
            print("chosen ",pair)
            ls.append([coin_name,percent_change_price,coin_symbol,base_coin,recent_vol_percentage, pings, net_vol_percentage])
...
def bot():
    ...
    while True:
        ...
        while not sold:
            ...
            print("Avg buy ",float_coin_price," Current price ",lastPrice," Limit sell at ",limit_price, "Stoploss at ", (1-stoploss_percentage/100)*float_coin_price)
            ...
            if (lastPrice >=limit_price) :
                ...
                try:
                    while True:
                        time.sleep(1)
                        lastPrice=get_price(order_coin_name)
                        print("\nInside profit : Avg buy ",float_coin_price," Current price ",lastPrice," Limit sell at ",maxPrice)
                        if lastPrice>limit_price:
                ...
                print("\nLimit 1  avg buy ",float_coin_price," current price ",lastPrice," limit sell at ",limit_price)
                ...
                limit_price=1.01*float_coin_price
                placeBuyOrderExcel(order_coin_name,net_quantity, float_coin_price)
                print("Limit 2  avg buy ",float_coin_price," current price ",lastPrice," limit sell at ",limit_price)
                ...
                limit_price=1.01*float_coin_price
                placeBuyOrderExcel(order_coin_name,net_quantity, float_coin_price)
                print("\nLimit 3  avg buy ",float_coin_price," current price ",lastPrice," limit sell at ",limit_price)
